...
urlpatterns = patterns('apps',
                       ...
                       url(r'^proyecto/(?P<pk_proyecto>\d+)/gestionar/(?P<pk_sprint>\d+)/$',
                           'sprints.views.sprint_gestionar', name='gestionar'),
                       url(r'^proyecto/(?P<pk_proyecto>\d+)/gestionar/(?P<pk_sprint>\d+)/horas/$',
                           'sprints.views.detalle_horas', name='detalle_horas'),
                       url(r'^proyecto/(?P<pk_proyecto>\d+)/asignar/(?P<pk_sprint>\d+)/user_story/(?P<pk_user_story>\d+)/$',
                           login_required(views.SprintAsignar.as_view()), name='asignar_sprint'),
                       ...
                       url(r'^proyecto/(?P<pk_proyecto>\d+)/kanban/(?P<pk_sprint>\d+)/notas/(?P<pk_user_story>\d+)/$',
                           login_required(views.AgregarNota.as_view()), name='notas'),
                       ...
                       url(r'^proyecto/(?P<pk_proyecto>\d+)/kanban/(?P<pk_sprint>\d+)/aprobar/(?P<pk_user_story>\d+)/$',
                           login_required(views.AprobarUserStory.as_view()), name='aprobar'),
                       ...
                       url(r'^proyecto/(?P<pk_proyecto>\d+)/kanban/(?P<pk_sprint>\d+)/agregar_adjunto/(?P<pk_user_story>\d+)/$',
                           'sprints.views.agregar_adjunto', name='agregar_adjunto'),
